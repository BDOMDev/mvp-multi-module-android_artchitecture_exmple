...
class TopRepoAdapter(): RecyclerView.Adapter<TopRepoAdapter.ViewHolder>() {

    private var repoList = ArrayList<Repository>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val binding = ItemTopRepoBinding.inflate(inflater, parent, false)
    ...
    inner class ViewHolder(itemRepoBinding: ItemTopRepoBinding) : RecyclerView.ViewHolder(itemRepoBinding.root) {
